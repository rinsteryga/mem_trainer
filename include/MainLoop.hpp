...
private:
    ...
    void display_training_header(TaskGenerator::Difficulty difficulty, size_t sequence_length);
    ...
    void save_training_results(size_t sequence_length, float success_rate, uint32_t score);
    void update_difficulty_if_needed(TaskGenerator::Difficulty difficulty, float success_rate);
    void print_results(uint32_t correct, size_t total, float success_rate,
